    ...
    <main className="min-h-screen flex items-center justify-center py-10 px-4">
      <div className="bg-card w-full max-w-md p-6 rounded-md shadow-md">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-button-secondary hover:bg-button-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
